...
with tab1:
    ...
    _render_tab_chatbot("tab1", "Tab 1 - Tổng quan", _build_tab1_context, filtered_df, active_cross_filters)

# ================= TAB 2 =================
with tab2:
    render_tab2(base_filtered_df, active_cross_filters, _apply_cross_filters, _sync_chart_selection)
    _render_tab_chatbot("tab2", "Tab 2 - Định nghĩa thành công", _build_tab2_context, filtered_df, active_cross_filters)

# ================= TAB 3 =================
with tab3:
    render_tab3(filtered_df, base_filtered_df, active_cross_filters, _apply_cross_filters, _sync_chart_selection)
    _render_tab_chatbot("tab3", "Tab 3 - Hành vi người dùng", _build_tab3_context, filtered_df, active_cross_filters)


# ================= TAB 4 =================
with tab4:
    render_tab4(filtered_df, base_filtered_df, active_cross_filters, _apply_cross_filters, _sync_chart_selection)
    _render_tab_chatbot("tab4", "Tab 4 - Nền tảng & Thuật toán", _build_tab4_context, filtered_df, active_cross_filters)
